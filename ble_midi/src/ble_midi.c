...
static struct bt_gatt_cb gatt_callbacks = {.att_mtu_updated = mtu_updated}; // TODO: must this be global?
...
static void on_connected(struct bt_conn *conn, uint8_t err)
{
	...
	LOG_INF("tx_running_status %d, tx_note_off_as_note_on %d", tx_running_status, tx_note_off_as_note_on);
